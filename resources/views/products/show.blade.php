    ...
    <div class="row g-5">
        ...
        <div class="col-lg-6">
            ...
            <div class="img-display-container">
                ...
                {{-- แก้ไขตรงนี้: เช็คว่าเป็น URL หรือว่าเป็นไฟล์ในเครื่อง --}}

                @if($product->image)

                    @if(filter_var($product->image, FILTER_VALIDATE_URL))

                        {{-- ถ้าเป็น URL (เหมือนในฐานข้อมูล SQL ของคุณ) ให้ดึงตรงๆ --}}

                        <img src="{{ $product->image }}" class="img-fluid" alt="{{ $product->name }}">

                    @else

                        {{-- ถ้าเป็นชื่อไฟล์ ให้ดึงจากโฟลเดอร์ images/products --}}
        ...
        <div class="col-lg-6">
            ...
            <div class="d-flex flex-column h-100">
                ...
                <div class="mb-2">
                    ...
                    <p class="text-muted">ID: {{ str_pad($product->id, 6, '0', STR_PAD_LEFT) }} | หมวดหมู่: {{ $product->category->name }}</p>
                ...
                <div class="mt-auto">
                    ...
                    <form action="{{ route('cart.add', $product->id) }}" method="POST">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <input type="number" name="quantity" value="1" min="1" max="{{ $product->stock }}" class="form-control quantity-selector">
                    ...
                    <p class="mt-3 text-muted small"><i class="fas fa-box me-1"></i> สินค้าคงเหลือในคลัง: {{ $product->stock }} ชิ้น</p>
